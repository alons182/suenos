...
<!-- The file upload form used as target for the file upload widget -->
    {{ Form::open(['route'=>'downloads_store_path','files'=> true, 'id'=>'fileupload']) }}
                ...
                <tr class="template-download ">
                        <td>
                            <span class="preview">
                                    ...
                                    <a href="/downloads_files/{{ $file['name'] }}" title="{{ $file['name'] }}" download="{{ $file['name'] }}" data-gallery>
                                    @if($file['type'] == 'jpg' || $file['type'] == 'jpeg' || $file['type'] == 'png' || $file['type'] == 'gif' )
                                        <img src="/downloads_files/thumbnail/{{ $file['name'] }}">
                                    @else
                        ...
                        <td>
                            <p class="name">
                                    ...
                                    <a href="/downloads_files/{{ $file['name'] }}" title="{{ $file['name'] }}">{{ $file['name'] }}</a>
                        ...
                        <td>
                                ...
                                <button class="btn btn-danger delete" data-type="DELETE" form="form-delete" data-url="/store/admin/downloads/{{ $file['name'] }}">
                                    <i class="glyphicon glyphicon-trash"></i>
                                    <span>Delete</span>
                                </button>
    ...
    <tr class="template-download fade">
        ...
        <td>
            {% if (file.deleteUrl) { %}
                ...
                <button class="btn btn-danger delete" data-type="{%=file.deleteType%}" data-url="/store/admin/downloads/{%=file.name%}" {% if (file.deleteWithCredentials) { %} data-xhr-fields='{"withCredentials":true}'{% } %}>
                    <i class="glyphicon glyphicon-trash"></i>
                    <span>Delete</span>
                </button>
                <input type="checkbox" name="delete" value="1" class="toggle">
